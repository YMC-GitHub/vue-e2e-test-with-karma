...
#https://www.findbestopensource.com/product/zenika-alpine-chrome

#install chromedriver
sed -i 's/dl-cdn.alpinelinux.org/mirrors.aliyun.com/g' /etc/apk/repositories && apk add --update chromium-chromedriver && rm -rf /var/cache/apk/*
...
#p="/mnt/code-store/nodejs/vue-spa-test-starter2" && cd "$p" && ./dev/dev-with-docker.sh
